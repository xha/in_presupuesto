...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $query = "SET ANSI_NULLS ON; SET ANSI_WARNINGS ON; SET NOCOUNT ON; EXEC SP_CONTEO '".$mes_inicio."','".$mes_final."'";
        $orden = $connection->createCommand($query)->queryOne();
        
        return $this->render('index', [
            'ordenes' => $orden['Orden'],
            'compras' => $orden['Compra'],
            'dev_compras' => $orden['Devolucion_Compra'],
            'cotizaciones' => $orden['Cotizacion'],
            'ventas' => $orden['Venta'],
